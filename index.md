...
- **人力成效**：在上述流程、分支策略、技术债与资源治理组合拳下，Treasury 相关前端的日常维护从原先约 **2** 名全职人力收敛为约 **0.5** 人即可稳定运转（其余人力可释放到其它业务线）。

## 技能与工具

- **语言与运行时**：TypeScript、JavaScript、HTML/CSS。
- **前端与工程化**：React、组件库与设计系统、国际化（i18n）、性能优化（包体、预取、离线）、可观测与看板。
- **架构与质量**：跨端宿主与 Web 同构、**xstate**、依赖注入；In-app Web 测试、客户端联调、自动化测试与稳定性保障。
...
- **Raycast**：参与 Raycast 社区生态的开源插件开发与维护；更多项目见 [GitHub · cy-98](https://github.com/cy-98)。
- **GitHub**：在多个仓库中持续提交 Issue / PR，具体仓库与话题可在面试中展开；欢迎通过 [Profile](https://github.com/cy-98) 浏览近年的贡献记录。
