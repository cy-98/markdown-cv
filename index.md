...
负责组件库的持续演进与维护，管理超过 100 个基础组件与业务组件。在保证组件质量与设计一致性的前提下，主导旧有组件的重构与废弃，并持续产出符合新设计规范的组件。
主导公司级组件库全面升级专项，推动超过 20 个团队将所有组件升级至最新版本，系统性消除 100+ 个 major gap。为攻克跨团队大规模升级的协作难题，自主研发了一套自动化升级工具链：编写 codemod 迁移脚手架实现代码变更的模板化生成，结合 AI 技术对存量页面进行批量改写，将原本需要大量人工介入的升级工作转化为可规模化执行的流程，显著加速了破坏性变更在各业务团队的落地效率。在日常协作机制上，构建了组件库使用情况的可视化看板，覆盖各团队版本分布与 bundle 体积增长趋势等关键指标；并通过定时任务自动向下游团队推送无破坏性变更的组件升级，减少人工跟进，保障升级节奏与版本一致性。
